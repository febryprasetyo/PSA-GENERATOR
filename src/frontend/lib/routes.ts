...
export const protectedNavItems = [
  { href: appRoutes.home, label: "Dashboard", icon: LayoutDashboard as ElementType, roles: ["admin", "operator", "client"] as UserRole[] },
  ...
  { href: appRoutes.database, label: "Database Logger", icon: Database as ElementType, roles: ["admin", "operator", "client"] as UserRole[] },
] as const;
