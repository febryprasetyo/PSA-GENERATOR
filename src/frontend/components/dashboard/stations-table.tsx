        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs text-dashboard-muted">
              {station.id} | {showArea && <>{station.areaName || "Belum Memiliki Area"} | </>}{station.region} | {station.machineCount} mesin | {station.runningTimeHours ? formatNumber(station.runningTimeHours) : 0} jam  <br/>Sync: {station.eventTimestamp || "-"}
            </p>
          </div>
        </div>
      </td>
